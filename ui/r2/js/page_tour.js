...
async function iniatePageTour() {
    ...
    var tourSteps = [
        ...
        },
        {
            ...
            position: 'left',            
            btnMsg: "Next",
            msg: "Click to activate. The status of the lasso is shown on the Lasso Status button.With the lasso activated, select the wells by drawing over the clusters or individual well icons (to draw click + hold the mouse button and move the cursor)."
        },
        {
        ...
        },
        {
            ...
            position: 'top',
            btnMsg: "Next",
            msg: "The wells you selected in the map section, that contain log/trajectory/marker data, are displayed in this table. Select the check boxes of the wells to be downloaded,searches the selected wells from the database opendes:0.2.1"
        },
        {
            selector: "#btnDownloadLasFiles",
            btnMsg: "Finish",
            msg: "Download LAS/Trajecotry/Marker files for the wells selected in the download table.",
            position: 'left',
